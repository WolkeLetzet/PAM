        ...
        <form action="" method="post">
            ...
            <div class="row">
                ...
                <div class="mb-3 col-6">
                    ...
                    class="form-control" name="so" id="so" placeholder="Sistema Operativo" value="{{$computer->so}}">
                ...
                <div class="mb-3 col-6">
                    ...
                    <input type="text" class="form-control" name="ram" id="ram" placeholder="RAM" value="{{$computer->ram}}">
                ...
                <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col">
                            <input type="text" class="form-control" name="encargado" id="Almacenamiento" placeholder="Almacenamiento" value="{{$computer->almacenamiento}}">
                ...
                <div class="mb-3 col-6">
                    ...
                    <input type="date" class="form-control" name="fecha" id="fecha" placeholder="Fecha" value="{{$computer->fecha}}">
